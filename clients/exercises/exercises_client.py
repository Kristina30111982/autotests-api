...
class ExercisesClient(APIClient):
    ...
    @allure.step("Get exercise by id {exercise_id}") # Добавили allure
    ...
    @allure.step("Create exercise")  # Добавили allure
    ...
    @allure.step("Update user by id {exercise_id}")  # Добавили allure шаг
    ...
    @allure.step("Delete user by id {exercise_id}")  # Добавили allure шаг
